...
class PropertyController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'address'   => 'required',
            'area'      => 'required',
            'image'     => 'required|file|mimes:jpeg,jpg,png,jfif,webp,gif,bmp',
            'floor_plan'=> 'nullable|file|mimes:jpeg,jpg,png,jfif,webp,gif,bmp',
    ...
    public function update(Request $request, $property)
    {
        $request->validate([
            ...
            'address'   => 'required',
            'area'      => 'required',
            'image'     => 'nullable|file|mimes:jpeg,jpg,png,jfif,webp,gif,bmp',
            'floor_plan'=> 'nullable|file|mimes:jpeg,jpg,png,jfif,webp,gif,bmp',
            'description'        => 'required',
            'location_latitude'  => 'required',
            'location_longitude' => 'required'
        ...
        // Visit RAMSEY for more projects
